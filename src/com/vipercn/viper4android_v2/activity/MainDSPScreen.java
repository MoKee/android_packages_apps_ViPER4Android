...
public final class MainDSPScreen extends PreferenceFragment {
    ...
    public static final String ACTION_UPDATE_UI = "com.vipercn.viper4android_v2.UPDATEUI";
...
//            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            int xmlId = R.xml.class.getField(config + "_headers_l" + mControlLevel)
                    .getInt(null);
...
//        getPreferenceScreen().removeAll();
    ...
    class UpdateUiReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            V4ASwitchPreference preference = (V4ASwitchPreference) MainDSPScreen.this.findPreference(key);
            if (preference != null) {
