...
//            }
            ...
            if (PREF_KEY_FORCE.equals(key)) {
                if (prefs.getBoolean(key, false)) {
                    ...
                    mDlgWarning.setMessage(getResources().getString(
            ...
            if (PREF_KEY_DDC.equals(key)) {
                if (prefs.getBoolean(key, false)) {
                    ...
                    if (!prefSettings.getBoolean("viper4android.settings.viperddc.notice", false)) {
                        ...
                        mNotice.setMessage(getResources().getString(
            ...
            Intent updateUiIntent = new Intent(MainDSPScreen.ACTION_UPDATE_UI);
            updateUiIntent.putExtra("key", key);
            getActivity().sendBroadcast(updateUiIntent);
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String config = getActivity().getIntent().getStringExtra("config");
        ...
        int mControlLevel = prefSettings.getInt("viper4android.settings.uiprefer", 2);
        ...
        try {
            int xmlId = R.xml.class.getField(config + "_preferences_l" + mControlLevel + "_" + flag)
                    .getInt(null);
